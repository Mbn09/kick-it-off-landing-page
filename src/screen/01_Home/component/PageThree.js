          ...
          <Row>
            <Col span={18} offset={3}>
              <Typography className="page03-right-content-hover" >
                ...
                verification process and <br /> the KIO program would <br /> be
                recommended based <br /> on your personality, <br /> skill and
                interest. The <br /> KIO program <br /> accompanies you <br />
                through your career <br /> challenges and <br /> opportunities.
              </Typography>
            </Col>
          </Row>
        </Col>
